        ...
        <div className="relative isolate px-6 pt-14 lg:px-8">
          ...
          <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
            <div className="mx-auto max-w-2xl lg:text-center">
              <h2 className="text-base font-semibold leading-7 text-indigo-600">Track Faster</h2>
              ...
              <div className="relative mx-auto max-w-2xl lg:mx-0">
                <figure>
                  <blockquote className="mt-6 text-lg font-semibold text-white sm:text-xl sm:leading-8">
                    <p>
                      "This platform has completely transformed how I manage my job search. 
                      I can easily track all my applications and stay organized throughout the process."
                    </p>
                  </blockquote>
                  <figcaption className="mt-6 text-base text-gray-300">
                    <div className="font-semibold">Sarah Chen</div>
                    <div className="mt-1">Software Engineer at Google</div>
                  </figcaption>
                </figure>
              </div>
            </div>
